...
This is the frontend Readme of the application, built with React. React was used due to its ease and flexibility. Also due to the easy way components can be reused throughout thr website. 
